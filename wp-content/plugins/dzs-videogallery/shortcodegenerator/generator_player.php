...
//    if($dzsvg->sample_data && is_array($dzsvg->sample_data)){
...
//        $ids.=$dzsvg->sample_data['media'][$i];
    ...
    ?>">
        <h3><?php echo __(" Shortcode Generator"); ?></h3>
    ...
    ?> data-label="<?php echo $lab; ?>">
        ...
        <div class="input-con type-<?php echo $opt['type']; ?>">
            ...
            if($opt['type'] == 'quality_selecter'){
                ...
                echo '<input type="text" class="shortcode-field textinput upload-prev upload-type-video big-field" name="qualities" value=""/><a class=" button-secondary quick-edit-qualityarray" href="#" style="cursor:pointer;">'.__("Edit Qualities").'</a>';
            ...
            if($opt['type'] == 'upload'){
                ...
                echo '<a href="#" class="button-secondary upload-for-target dzsvg-wordpress-uploader">'.__("Upload").'</a>';
            }
            if($opt['type'] == 'select'){
