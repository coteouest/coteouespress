...
//		global $dzstln; print_r($dzstln->post_types);
		return array(
      'title'       => __( 'Video Player DZS ', 'dzsvg' ),
      'autofocus' => array(
...
//        error_log(print_rr($dzsvg->options_array_player, array('echo'=>false)));
...
//        error_log(print_rr($options_array, array('echo'=>false)));
        ...
        return array(
            ...
            'source' => array(
                'type' => 'text',
                'ui' => array(
                    'title' => __( 'Mode3', 'dzsvg' ),
                    'tooltip' => __( 'Choose to display the heading vertically or horizonatally', 'dzsvg' ),
                ),

                'context' => 'content',
                'suggest' => __( 'The link to a mp4', 'dzsvg' ),
            ),
