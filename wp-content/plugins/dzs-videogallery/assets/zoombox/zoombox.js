...
//                console.log('testtt', get_query_arg(theurl, 'zoombox'));
                        ...
                        if(_theItem.children('.main-con').length>0){
                            ...
                            if(_c_sliderCon.attr('data-element-width') && _c_sliderCon.attr('data-element-height')){
                                ...
                                if(_c_sliderCon_item.hasClass('advancedscroller')){
                                    if(_c_sliderCon_item.get(0) && _c_sliderCon_item.get(0).api_handleResize) {
        ...
        function close_zoombox(){
            ...
            if(o.settings_deeplinking=='on' && can_history_api()==true){
...
//            console.info('click_item');
            ...
            var safe_to_go = true;
            if(e){
                if(e.target && $(e.target).hasClass('ignore-zoombox')){
...
//                console.info($.fn.vPlayer)
            ...
            if(the_type=='audio'){
                ...
                if (_t.attr('data-previewimg')) {
                    margs.media_coverimage = _t.attr('data-previewimg');
                }
            }
...
//                    console.log(_cach, _t, _cach==_t);
        ...
        function gotoItem(arg, argtype, otherargs) {
            ...
            if(o.settings_deeplinking=='on' && can_history_api()==true && otherargs.forcenodeeplink!='on'){
...
//                    console.info(bigwidth, bigheight);
                        ...
                        if(is_mobile()){
                            ...
                            videoplayersettingsholder.settings_video_overlay = 'on';
                        }
                        ...
                        // console.warn('videoplayersettingsholder - ',videoplayersettingsholder);
                            ...
                            if(_holder.find('.vplayer').get(0) && _holder.find('.vplayer').get(0).api_playMovie){
                                ...
                                if(videoplayersettingsholder.zoombox_video_autoplay=='on'){
                                    ...
                                    _holder.find('.vplayer').get(0).api_playMovie({
                                        'call_from':'play_only_on_desktop'
                                    });
                                }else{
            ...
            if (argtype == 'audio') {
                if ($.fn.audioplayer != undefined) {
                    ...
                    if (otherargs.media_coverimage != '') {
                        ...
                        coverimage = otherargs.media_coverimage
                    }
                    console.info('otherargs.item - ', otherargs.item);


                    var _it = otherargs.item;
                    if(coverimage){

                    }else{
                        if(_it){

                            if(_it.find('.divimage').length){
                                coverimage = _it.find('.divimage').eq(0).css('background-image');
                                coverimage = coverimage.replace('url(','');
                    ...
                    console.info('bigwidth - ',bigwidth);
                    console.info('bigheight - ',bigheight);
...
//            console.info(otherargs);
            ...
            if(typeof otherargs.title!='undefined' && otherargs.title!=''){
                ...
                auxs = '<h5>'+auxs+'</h5><h6 class="index-definer">'+aux2+'/'+aux3+'</h6>'
