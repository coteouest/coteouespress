    ...
    ?>" data-demo="<?php echo $margs['demo-slug']; ?>"><?php
        ...
        if($dzsvg->mainoptions['dzsvg_purchase_code_binded']=='on'){
            ...
            ?><div class=" dzstooltip skin-black arrow-bottom align-left">
                <?php echo __("You need to activate video gallery with purchase code before importing demos");
                ?>
            </div>
            <?php
        }
...
"><?php echo __("Quick Edit Gallery"); ?></a></p>
    ...
    <div class="feedbacker"><i class="fa fa-circle-o-notch fa-spin"></i> <?php echo __("Loading",'dzsvg'); ?>... </div>

    <div id="import-sample-lib" class="show-in-ultibox"><?php

        echo '<h3>'.__("Import Demo",'dzsvg').'</h3>';


    $args = array(
        'featured_image' => $dzsvg->thepath.'img/sample_1.jpg',
        'title' => 'Sample Wall',
        ...
        $args = array(
            'featured_image' => $dzsvg->thepath.'img/sample_2.jpg',
        ...
        $args = array(
            'featured_image' => $dzsvg->thepath.'img/sample_3.jpg',
        ...
        $args = array(
            'featured_image' => $dzsvg->thepath.'img/sample_4.jpg',
            'title' => 'Balne Setup',
